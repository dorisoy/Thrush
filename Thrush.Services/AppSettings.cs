...
namespace Thrush.Services
{
    public static class AppSettings
    {
        public static readonly string AppName = "Thrush";
        public static readonly string AppIdentifier = "com.baseflow.thrush";
        ...
        public static readonly string TextProviderNamespace = "Thrush.Core";
